...
This project is a Python web application using **Flask** that retrieves data about Pokémon from the public [PokeAPI](https://pokeapi.co/), logs user queries, and is fully automated for deployment via **CI/CD**, **Docker**, **Kubernetes**, **HPA**, and **Monitoring**.
